...
const hoteles = [
  ...
  { id: 7, nombre: "Hotel Villajardín", desc: "Un espacio funcional para estancias cortas.", link: "https://hotelvillanueva.com.mx/hotel/hotel-villa-jardin/", cat: "FUNCIONAL", img: "https://hotelvillanueva.com.mx/wp-content/uploads/hotel-villa-jardin-300x200.jpg" },
  { id: 8, nombre: "Parque Satélite", desc: "La mejor alternativa para negocios o placer.", link: "https://www.hotelparquesatelite.com/", cat: "VERSÁTIL", img: "https://media-cdn.tripadvisor.com/media/photo-s/04/09/d3/f8/parque-satelite.jpg" },
  { id: 9, nombre: "Krystal Satélite", desc: "Equilibrio perfecto entre descanso y negocios.", link: "https://www.krystalsatelitemariabarbara.com/", cat: "RELAX", img: "https://media-cdn.tripadvisor.com/media/photo-s/0c/74/5a/bf/krystal-satelite-maria.jpg" },
  { id: 10, nombre: "NH Valle Dorado", desc: "Hotel 4 estrellas con habitaciones contemporáneas.", link: "https://www.nhhotels.com/en/hotel/nhmexicocityvalledorado", cat: "PREMIUM", img: "https://media-cdn.tripadvisor.com/media/photo-s/2f/6e/da/95/facade.jpg" },
  { id: 11, nombre: "Hotel IBIS", desc: "Económico, dinámico y abierto a todo el mundo.", link: "https://all.accor.com/hotel/A6I0/index.en.shtml", cat: "ECONÓMICO", img: "https://www.ahstatic.com/photos/a0v4_ho_00_p_1024x768.jpg" }
];
